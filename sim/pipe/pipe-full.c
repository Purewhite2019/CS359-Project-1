...
int gen_f_pc()
{
    return (((((ex_mem_curr->icode) == (I_JMP)) & !
          (ex_mem_curr->takebranch)) & ((((ex_mem_curr->ifun) == (C_LE) || 
              (ex_mem_curr->ifun) == (C_L) || (ex_mem_curr->ifun) == (C_E)
               || (ex_mem_curr->ifun) == (C_NE) || (ex_mem_curr->ifun) == 
              (C_GE) || (ex_mem_curr->ifun) == (C_G)) & (
              (mem_wb_curr->icode) == (I_ALU) || (mem_wb_curr->icode) == 
              (I_IADDL))) | !((ex_mem_curr->ifun) == (C_LE) || 
            (ex_mem_curr->ifun) == (C_L) || (ex_mem_curr->ifun) == (C_E)
             || (ex_mem_curr->ifun) == (C_NE) || (ex_mem_curr->ifun) == 
            (C_GE) || (ex_mem_curr->ifun) == (C_G)))) ? (ex_mem_curr->vala)
...
int gen_f_predPC()
{
    return (((((((((((if_id_next->icode) == (I_JMP)) & ((if_id_next->ifun)
                         == (C_LE))) & !((if_id_curr->icode) == (I_ALU) || 
                      (if_id_curr->icode) == (I_IADDL))) & 
                  ((GET_SF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in))^GET_OF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in)))|GET_ZF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in)))
                  ) | (((((if_id_next->icode) == (I_JMP)) & (
                        (if_id_next->ifun) == (C_L))) & !(
                      (if_id_curr->icode) == (I_ALU) || (if_id_curr->icode)
                       == (I_IADDL))) & 
                  (GET_SF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in))^GET_OF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in)))
                  )) | (((((if_id_next->icode) == (I_JMP)) & (
                      (if_id_next->ifun) == (C_E))) & !((if_id_curr->icode)
                     == (I_ALU) || (if_id_curr->icode) == (I_IADDL))) & 
                (GET_ZF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in)))
                )) | (((((if_id_next->icode) == (I_JMP)) & (
                    (if_id_next->ifun) == (C_NE))) & !((if_id_curr->icode)
                   == (I_ALU) || (if_id_curr->icode) == (I_IADDL))) & 
              (GET_ZF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in))^1)
              )) | (((((if_id_next->icode) == (I_JMP)) & (
                  (if_id_next->ifun) == (C_GE))) & !((if_id_curr->icode)
                 == (I_ALU) || (if_id_curr->icode) == (I_IADDL))) & 
            (GET_SF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in))^GET_OF(((id_ex_curr->icode == I_ALU || id_ex_curr->icode ==  I_IADDL) ? compute_cc(gen_alufun(), gen_aluA(), gen_aluB()) : cc_in))^1)
            )) | (((((if_id_next->icode) == (I_JMP)) & ((if_id_next->ifun)
                 == (C_G))) & !((if_id_curr->icode) == (I_ALU) || 
              (if_id_curr->icode) == (I_IADDL))) & 
...
int gen_D_bubble()
{
    return (((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch)
          ) & ((((id_ex_curr->ifun) == (C_LE) || (id_ex_curr->ifun) == 
              (C_L) || (id_ex_curr->ifun) == (C_E) || (id_ex_curr->ifun)
               == (C_NE) || (id_ex_curr->ifun) == (C_GE) || 
              (id_ex_curr->ifun) == (C_G)) & ((ex_mem_curr->icode) == 
              (I_ALU) || (ex_mem_curr->icode) == (I_IADDL))) | !(
            (id_ex_curr->ifun) == (C_LE) || (id_ex_curr->ifun) == (C_L) || 
            (id_ex_curr->ifun) == (C_E) || (id_ex_curr->ifun) == (C_NE) || 
            (id_ex_curr->ifun) == (C_GE) || (id_ex_curr->ifun) == (C_G))))
